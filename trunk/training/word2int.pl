...
word2int.pl - replaces each word by its index in a .vcb file passed as argument.

=head1 SYNOPSIS

perl word2int.pl [options] -vcb vocabulary_file < input_words_text > output_indices_text
